...
export const metadata: Metadata = {
  title: "Pricing | SUI The DREAM UI Components for Web Development",
  description:
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://sui.whysumancode.com/dashboard/hero",
...
export default function NavbarLayout({
  ...
  return (
    <>
      <Head>
        <title>
          {"Hero | SUI The DREAM UI Components for Web Development"}
        </title>
        <meta
          name="description"
          content={
